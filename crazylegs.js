...
//MyAvatar.setJointData("joint_L_arm", Quat.fromPitchYawRollDegrees(0.0, 0.0, 90.0));

Script.update.connect(function(deltaTime) {
    cumulativeTime += deltaTime;
    MyAvatar.setJointData("joint_L_arm", Quat.fromPitchYawRollDegrees(0.0, 0.0, 45.0));
    MyAvatar.setJointData("joint_L_shoulder", Quat.fromPitchYawRollDegrees(0.0, 0.0, 45.0 + 10.0 * Math.sin(cumulativeTime * FREQUENCY)));

    //MyAvatar.setJointData("joint_L_shoulder", Quat.fromPitchYawRollDegrees(0.0, 0.0, 45.0 + AMPLITUDE * Math.sin(cumulativeTime * FREQUENCY)));
...
Script.scriptEnding.connect(function() {
  MyAvatar.clearJointData("joint_L_arm");
  MyAvatar.clearJointData("joint_L_shoulder");
